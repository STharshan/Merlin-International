...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Had an issue with my breaks whilst away on a camping trip after ringing around numerous garages and having no luck we was recommended Merlin international, rent up and he told us to pop down even on his day off and sorted the problem within 2 minutes, would highly recommend the garage company.",
    name: "Dell & Declon",
  },
